...
<body style="background-image: url('./images./pic1.jpg');background-repeat: no-repeat;background-size:cover;">

<div class="overlay">
  <div class="container">
    <h1 style=" color:black;"> VIDEO CONFERANCING PLATFORM</h1>
    <p>"Thank you for choosing video conferancing platform. Let's connect, collaborate, and create together!"</p>
